...
A transport ticket of any sort was believed to posess luck if sum of digits on the left
half of its number was equal to the sum of digits on the right half. 
...
Your task is to write a funtion luck_check(str), which returns true/True 
